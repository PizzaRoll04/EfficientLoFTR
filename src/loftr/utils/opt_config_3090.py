...
_CN.COARSE.NPE = [
    ...
    128,
    128,
]  # [832, 832, long_side, long_side] Suggest setting based on the long side of the input image, especially when the long_side > 832
...
_CN.MATCH_COARSE.SKIP_SOFTMAX = (
    True  # False for full model and True for optimized model
)
...
_CN.MATCH_FINE = CN()
_CN.MATCH_FINE.LOCAL_REGRESS_TEMPERATURE = (
    10.0  # use 10.0 as fine local regress temperature, not 1.0
)
_CN.MATCH_FINE.LOCAL_REGRESS_SLICEDIM = 8

opt_cfg_3090 = lower_config(_CN)
